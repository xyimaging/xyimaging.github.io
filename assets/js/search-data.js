...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "Selected repositories from my personal GitHub and the MedICL lab organization.",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "please see my full bibliography on the pdf",
          section: "Navigation",
          handler: () => {
            window.location.href = "/cv/";
          },
        },{id: "post-i-built-an-agent-that-can-operate-a-3d-medical-image-registration-gui",
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/agent-guided-medical-image-registration/";
        ...
        handler: () => {
            ...
            window.location.href = "/blog/2026/agentic-rag-eval/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/XingYao_CV.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%61%6C%65%78%79%61%6F%39%39%37%37@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=QPEhFegAAAAJ", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/xyimaging", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/xing-yao-2205b1191", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
